...
def option():
    # Training settings
    parser = argparse.ArgumentParser(description='HVI-Dual-NAF')
    ...
    parser.add_argument('--resume_dir', type=str, default='', help='resume from an existing run dir (logs/...); skip creating a new run dir')
    ...
    parser.add_argument('--data_train_lol_v1'       , type=str, default='/mnt/wsl/wsl-data/data/lol_dataset/our485')
    ...
    parser.add_argument('--data_val_lol_v1'         , type=str, default='/mnt/wsl/wsl-data/data/lol_dataset/eval15/low')
    ...
    parser.add_argument('--data_valgt_lol_v1'       , type=str, default='/mnt/wsl/wsl-data/data/lol_dataset/eval15/high/')
