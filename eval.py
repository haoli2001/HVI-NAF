...
if __name__ == '__main__':
    ...
    alpha = None
    if ep.lol:
        eval_data = DataLoader(dataset=get_eval_set("/mnt/wsl/wsl-data/data/lol_dataset/eval15/low"), num_workers=num_workers, batch_size=1, shuffle=False)
        output_folder = './output/LOLv1/'
        if ep.perc:
            weight_path = './weights/LOLv1/huggingface_w_perc.pth'
        else:
            weight_path = './weights/LOLv1/huggingface_wo_perc.pth'
